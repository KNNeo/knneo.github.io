...
function crawlShowsList() {
	staggerCall(config.ids, 'https://api.jikan.moe/v4/anime/{id}', processShow, config.delay);
}
...
function crawlCharactersList() {
	staggerCall(config.ids, 'https://api.jikan.moe/v4/anime/{id}/characters', processCharacters, config.delay);
}
