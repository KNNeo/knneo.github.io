...
Dictionary<int, String> PAGE_TAGS = new Dictionary<int, String>() {
	{0, ""},
	{1, "TakahashiRie,Colleague,Lunch,ActOfKindness"},
	{2, "AmamiyaSora,Acquaintance,Cooking,RejectedInHighSchool"},
	{3, "AsakuraMomo,Acquaintance,TrainRide,ChitChat"},
	{4, "NatsukawaShiina,YoungerStepsister,ShoppingDistrict,Keychain"},
	{5, "HanazawaKana,Acquaintance,MyMansion,Rain,FirstEncounter"},
	{6, "MinaseInori,Benefactor,SummerFestival,PlaygroundRide"},
	{7, "WakiAzumi,Neighbour,FootBath,HangingOut"},
	{8, "MinaseInori,Benefactor,SummerFestival,Sparklers"},
	{9, "KogaAoi,Girlfriend,SummerFestival,ShavedIce,Jealous"},
	{10, "KitouAkari,ExGirlfriend,FamilyRestaurant,NewMenu,Flashback"},
	{11, "KitouAkari,ExGirlfriend,ChristmasParty,LoveConfession,Flashback"},
	{12, "ToyosakiAki,Stranger,BicycleRental,HangingOut,Flashback"},
	{13, "HanazawaKana,Acquaintance,BreadShop,ReturningFavour"},
	{14, "KomatsuMikako,Neighbour,Cafe,NTR,Flashback"},
	{15, "TachibanaRika,Stranger,Cafe,LookingFromAfar,Flashback"},
	{16, "TaketatsuAyana,Cousin,Married,HoldingHands,Flashback"},
	{17, "MinaseInori,Benefactor,NatsukawaAbode,PersonalCollection"},
	{18, "NatsukawaShiina,YoungerStepsister,NatsukawaAbode,MorningBrew"},
	{19, "KitouAkari,ExGirlfriend,Christmas,PairOfGloves,Flashback"},
	{20, "UesakaSumire,Stranger,ChristmasParty,PickUpGirl,Secret"},
	{21, "TakahashiRie,Colleague,NewYears,HouseDate"},
	{22, "KogaAoi,Girlfriend,BadWeather,BeachDate"},
	{23, "KounoMarika,Cousin,SummerHolidays,Flashback"},
	{24, "TakahashiRie,Colleague,AmusementPark,BirthdayGift"},
	{25, "NatsukawaShiina,YoungerStepsister,Meetup,FirstEncounter,Flashback"},
	{26, "MinaseInori,Benefactor,NatsukawaAbode,WhiteDay"},
	{27, "KannoMai,Tenant,MyMansion,BrushingUp"},
	{28, "NagaeRika,ChildhoodFriend,Aquarium,HangingOut"},
	{29, "AmamiyaSora,Acquaintance,CherryBlossoms,PickUpLine"},
	{30, "AmamiyaSora,Acquaintance,SharedRoom,OneNightStay"},
	{31, "AmamiyaSora,Acquaintance,SharedRoom,IntimateSuggestion"},
	{32, "KitouAkari,ExGirlfriend,WinterHolidays,FirstDate,Flashback"},
	{33, "AizawaSaya,Acquaintance,CocktailBar,FirstEncounter"},
	{34, "UesakaSumire,ExColleague,ChristmasEve,HelpingHand"},
	{35, "UedaReina,Acquaintance,SecretHideout,FirstEncounter"},
	{36, "AsakuraMomo,Acquaintance,TrainRide,LoveConfession"},
	{37, "TakahashiRie,Colleague,Dinner,Confession,Rejection"},
	{38, "UedaReina,Acquaintance,NatsukawaAbode,Advice,ReverseConfession"},
	{39, "NatsukawaShiina,YoungerStepsister,TrySail,AmamiyaSora,AsakuraMomo,Jealous,Mesaging"},
	{40, "HanazawaKana,Acquaintance,Relative,GrandmaPlace,Surprise"},
	{41, "IshiharaKaori,Stranger,TempleVisit,Yukata,SummerFestival"},
	{42, "OguraYui,Tenant,MyMansion,ShutIn,Streamer,CupNoodles"},
	{43, "KannoMai,Tenant,MyMansion,Gossip"},
	{44, "KogaAoi,Girlfriend,TrainStation,LoveyDovey"},
	{45, "AmamiyaSora,Acquaintance,Rowboat,HighSchool,Flashback"},
