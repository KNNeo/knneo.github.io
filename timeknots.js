var TimeKnots = {
  draw: function(id, events, options){
    ...
    return tip.style("left", (document.getElementById(id.toString().substring(1)).getBoundingClientRect().x+d3.mouse(document.getElementById(id.toString().substring(1)))[0])+"px").style("top", (document.getElementById(id.toString().substring(1)).getBoundingClientRect().y+d3.mouse(document.getElementById(id.toString().substring(1)))[1])+"px");})//.style("top", (d3.event.pageY-tipPixels-margin)+"px").style("left",(d3.event.pageX+20)+"px");}) //top and left are aligned wrongly
