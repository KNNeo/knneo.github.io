...
s.LyricsURL, 
coalesce(s.SongTitleAlt, s.SongTitle) as 'SongTitleAlt',
coalesce(s.ArtistTitleAlt, s.ArtistTitle) as 'ArtistTitleAlt',
coalesce(s.ReleaseTitleAlt, s.ReleaseTitle) as 'ReleaseTitleAlt',
coalesce(s.ReleaseArtistTitleAlt, s.ReleaseArtistTitle) as 'ReleaseArtistTitleAlt',
a.ArtistCode,
