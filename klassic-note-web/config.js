...
const coverArtDirectoryFormat = 'default'; // for coverArtDirectory: if empty or default follow above format, if full then full link to be in db, if merge then will only use coverArtDirectory assume all files in one folder
