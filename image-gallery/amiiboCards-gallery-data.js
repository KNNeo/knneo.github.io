...
for(let i = 6; i < document.getElementsByTagName('tr').length; i++)
{
    output += '"' + document.getElementsByTagName('tr')[i].getElementsByTagName('td')[0].innerText.replace(' ', '').replace('\'', '').replace('.', '') + '": ' + "\'" + document.getElementsByTagName('tr')[i].getElementsByTagName('td')[3].innerText + '\', ';
	
}
output += '};';
console.log(output);
*/
//run above on console, generate variable dictionary

//to generate image array https://animal-crossing.com/amiibo/collections/series-1-4-amiibo-cards/
/*
for(counter = 0; counter < 100; counter++) //extend count list, use notepad++ to add number
{
    ...
    console.log("[" + (counter+1) + ", '" + image.src + "', 'portrait', '" + (dictionary[label.innerText] || '') + "', '" + label.innerText + "'],");
}
*/
...
[401, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MASX-USZ-F0(0)869.png', 'portrait', 'Special Characters', 'Tom Nook'],
[402, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MASY-USZ-F0(0)870.png', 'portrait', 'Special Characters', 'Timmy & Tommy'],
[403, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MASZ-USZ-F0(0)871.png', 'portrait', 'Special Characters', 'Isabelle'],
[404, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAUX-USZ-F0(0)872.png', 'portrait', 'Special Characters', 'Orville'],
[405, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAUY-USZ-F0(0)873.png', 'portrait', 'Special Characters', 'Wilbur'],
[406, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MATC-USZ-F0(0)874.png', 'portrait', 'Special Characters', 'Blathers'],
[407, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MATD-USZ-F0(0)875.png', 'portrait', 'Special Characters', 'Celeste'],
[408, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MATE-USZ-F0(0)876.png', 'portrait', 'Special Characters', 'Mabel'],
[409, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MATF-USZ-F0(0)877.png', 'portrait', 'Special Characters', 'Sable'],
[410, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MATG-USZ-F0(0)878.png', 'portrait', 'Special Characters', 'Label'],
[411, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MATH-USZ-F0(0)879.png', 'portrait', 'Special Characters', 'K.K.'],
[412, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAUZ-USZ-F0(0)880.png', 'portrait', 'Special Characters', 'C.J.'],
[413, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVA-USZ-F0(0)881.png', 'portrait', 'Special Characters', 'Flick'],
[414, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVB-USZ-F0(0)882.png', 'portrait', 'Special Characters', 'Daisy Mae'],
[415, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MATM-USZ-F0(0)883.png', 'portrait', 'Special Characters', 'Kicks'],
[416, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MATN-USZ-F0(0)884.png', 'portrait', 'Special Characters', 'Saharah'],
[417, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVC-USZ-F0(0)885.png', 'portrait', 'Special Characters', 'Harvey'],
[418, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MATQ-USZ-F0(0)886.png', 'portrait', 'Special Characters', 'Gulliver'],
[419, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVD-USZ-F0(0)887.png', 'portrait', 'Special Characters', 'Wisp'],
[420, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MATS-USZ-F0(0)888.png', 'portrait', 'Special Characters', 'Lottie'],
[421, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVE-USZ-F0(0)889.png', 'portrait', 'Special Characters', 'Niko'],
[422, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVF-USZ-F0(0)890.png', 'portrait', 'Special Characters', 'Wardell'],
[423, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MATV-USZ-F0(0)891.png', 'portrait', 'Special Characters', 'Tom Nook'],
[424, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MATW-USZ-F0(0)892.png', 'portrait', 'Special Characters', 'Isabelle'],
[425, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVG-USZ-F0(0)893.png', 'portrait', 'Goat', 'Sherb'],
[426, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVH-USZ-F0(0)894.png', 'portrait', 'Bear', 'Megan'],
[427, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVJ-USZ-F0(0)895.png', 'portrait', 'Sheep', 'Dom'],
[428, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVK-USZ-F0(0)896.png', 'portrait', 'Wolf', 'Audie'],
[429, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVL-USZ-F0(0)897.png', 'portrait', 'Elephant', 'Cyd'],
[430, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVM-USZ-F0(0)898.png', 'portrait', 'Cub', 'Judy'],
[431, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVN-USZ-F0(0)899.png', 'portrait', 'Cat', 'Raymond'],
[432, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVP-USZ-F0(0)900.png', 'portrait', 'Horse', 'Reneigh'],
[433, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVQ-USZ-F0(1)901.png', 'portrait', 'Rabbit', 'Sasha'],
[434, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVR-USZ-F0(0)902.png', 'portrait', 'Squirrel', 'Ione'],
[435, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVS-USZ-F0(0)903.png', 'portrait', 'Monkey', 'Tiansheng'],
[436, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVT-USZ-F0(0)904.png', 'portrait', 'Deer', 'Shino'],
[437, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVU-USZ-F0(0)905.png', 'portrait', 'Hamster', 'Marlo'],
[438, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVV-USZ-F0(0)906.png', 'portrait', 'Mouse', 'Petri'],
[439, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVW-USZ-F0(0)907.png', 'portrait', 'Octopus', 'Cephalobot'],
[440, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVX-USZ-F0(0)908.png', 'portrait', 'Eagle', 'Quinn'],
[441, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVY-USZ-F0(0)909.png', 'portrait', 'Penguin', 'Chabwick'],
[442, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAVZ-USZ-F0(0)910.png', 'portrait', 'Anteater', 'Zoe'],
[443, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAWA-USZ-F0(0)911.png', 'portrait', 'Bird', 'Ace'],
[444, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAWB-USZ-F0(0)912.png', 'portrait', 'Ostrich', 'Rio'],
[445, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAWC-USZ-F0(0)913.png', 'portrait', 'Dog', 'Frett'],
[446, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAWD-USZ-F0(0)914.png', 'portrait', 'Rhino', 'Azalea'],
[447, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAWE-USZ-F0(0)915.png', 'portrait', 'Alligator', 'Roswell'],
[448, 'https://animal-crossing.com/amiibo/assets/img/cards/NVL-C-MAWF-USZ-F0(0)916.png', 'portrait', 'Koala', 'Faith'],
[999, '', '', '', '']
];
