...
s.LyricsURL, 
coalesce(s.SongTitleAlt, s.SongTitle), 
coalesce(s.ArtistTitleAlt, s.ArtistTitle), 
coalesce(s.ReleaseTitleAlt, s.ReleaseTitle), 
coalesce(s.ReleaseArtistTitleAlt, s.ReleaseArtistTitle), 
a.ArtistCode,
