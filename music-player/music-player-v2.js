...
timestamps.push(['2021', 20, 126, 17, 'Yoin', 'pandora']);
timestamps.push(['2021', 18, 169, 17, 'No Buses', 'Girl']);
timestamps.push(['2021', 19, 216, 16, 'a flood of circle', 'Hokkyokusei no Melody']);
...
timestamps.push(['2021', 14, 384, 12, 'yorushika', 'Matasaburou']);
timestamps.push(['2021', 13, 434, 11, 'SID', 'Star Forest']);
timestamps.push(['2021', 12, 484, 10, 'Takahashi Rie', 'Uutsu']);
timestamps.push(['2021', 11, 527, 10, 'Kitou Akari', 'No Continue']);
...
timestamps.push(['2021',  8, 657,  7, 'Tomita Miyu', 'Dilenma']);
timestamps.push(['2021',  7, 692,  7, 'Asakura Momo', 'Pinky Hook']);
timestamps.push(['2021',  5, 733,  6, 'cinema staff', 'Kyokuya']);
timestamps.push(['2021',  6, 775,  5, 'anewhite', 'Gunjougeki ni wa Iranai']);
