...
timestamps.push(['2014', 24, 0000,  1, 'nano.RIPE', 'Toumei na Sekai']);
timestamps.push(['2014', 23, 0000,  2, 'SCANDAL', 'Image']);
timestamps.push(['2014', 22, 0000,  3, 'Aqua Timez', 'Hinayume']);
timestamps.push(['2014', 20, 0000,  4, 'fumika', 'Endless Road']);
timestamps.push(['2014', 21, 0000,  4, 'BIGNOUN', 'FRICTION']);
timestamps.push(['2014', 19, 0000,  5, 'miwa', 'Faith']);
timestamps.push(['2014', 17, 0000,  6, 'Ikimonogakari', 'GOLDEN GIRL']);
timestamps.push(['2014', 18, 0000,  6, 'Neat\'s', 'MOA']);
timestamps.push(['2014', 16, 0000,  7, 'Primary', 'fragile garden']);
timestamps.push(['2014', 15, 0000,  8, 'Chatmonchy', 'Kokoro to Atama']);
timestamps.push(['2014', 14, 0000,  9, 'NEGOTO', 'Tasogare no Rhapsody']);
timestamps.push(['2014', 13, 0000, 10, 'cinema staff', 'borka']);
timestamps.push(['2014', 11, 0000, 11, 'nano.RIPE', 'Zettaichi']);
timestamps.push(['2014', 12, 0000, 11, 'yanaginagi', 'Esse']);
timestamps.push(['2014', 10, 0000, 12, 'TOKYO SKA PARADISE ORCHESTRA', 'Wake Up! feat. ASIAN KUNG-FU GENERATION']);
timestamps.push(['2014', 9, 0000, 13, 'Kon Natsumi', 'Gift']);
timestamps.push(['2014', 8, 0000, 14, 'iki', 'Kansen']);
timestamps.push(['2014', 7, 0000, 15, 'Tsuzuri Zukuri', 'Tsubame']);
timestamps.push(['2014', 6, 0000, 16, 'SID', 'hug']);
timestamps.push(['2014', 5, 0000, 17, 'Toyosaki Aki', 'Kanae Tamae']);
timestamps.push(['2014', 4, 0000, 18, 'Takebuchi Kei', 'MERMAID']);
timestamps.push(['2014', 2,  35, 19, 'Komatsu Mikako', 'Emerald no Oka wo Koete']);
timestamps.push(['2014', 3,  80, 19, 'Kotobuki Minako', 'Chiisana Tegami']);
timestamps.push(['2014', 1,   0, 20, 'fhana', 'Itsuka no, Ikutsuka no Kimi to no Sekai']);
